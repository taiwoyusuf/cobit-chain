...
MARKER = "IRLT_EXECUTIVE_COMMAND_BRIDGE_ENGINE_V1_ACTIVE"

if MARKER in text:
    print("Executive Command Bridge already exists.")
    raise SystemExit()
...
print("Executive Command Bridge appended successfully.")
