...
inject = """
        ...
        <div class=\"section\">
            ...
            <div style=\"padding:30px;border-radius:18px;background:linear-gradient^(135deg,#07111f,#0d2f46^);border:1px solid #1ee6a5;margin-top:20px;\">
                ...
                <div style=\"display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:18px;text-align:center;font-weight:700;\">
                    ...
                    <div>
                        <div style=\"font-size:12px;color:#7fdcff;\">Protocol</div>
                        <div style=\"padding:16px;border-radius:12px;background:#09243a;\">v4.1 Approved</div>
                    </div>

                    <div style=\"font-size:30px;color:#1ee6a5;\"></div>

                    <div>
                        <div style=\"font-size:12px;color:#7fdcff;\">eConsent</div>
                        <div style=\"padding:16px;border-radius:12px;background:#09243a;\">Verified</div>
                    </div>

                    <div style=\"font-size:30px;color:#1ee6a5;\"></div>

                    <div>
                        <div style=\"font-size:12px;color:#7fdcff;\">EDC Capture</div>
                        <div style=\"padding:16px;border-radius:12px;background:#09243a;\">Validated</div>
                    </div>

                    <div style=\"font-size:30px;color:#ffd166;\"></div>

                    <div>
                        <div style=\"font-size:12px;color:#7fdcff;\">Safety Review</div>
                        <div style=\"padding:16px;border-radius:12px;background:#3a2409;color:#ffd166;\">Pending</div>
                    </div>

                    <div style=\"font-size:30px;color:#ff5d73;\"></div>

                    <div>
                        <div style=\"font-size:12px;color:#7fdcff;\">Governance Verdict</div>
                        <div style=\"padding:16px;border-radius:12px;background:#3a0911;color:#ff7f90;\">Conditionally Defensible</div>
                    </div>
        ...
        <div class=\"section\">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>Protocol v4.1</td>
                    <td>VERIFIED</td>
                    <td>Operational Trust Maintained</td>
                </tr>

                <tr>
                    <td>Site Monitoring</td>
                    <td>CAPA-019 Closure</td>
                    <td>PENDING</td>
                    <td>Inspection Defensibility Reduced</td>
                </tr>

                <tr>
                    <td>Safety Review</td>
                    <td>SAE Closure Evidence</td>
                    <td>BLOCKED</td>
                    <td>Submission Release Risk</td>
                </tr>

                <tr>
                    <td>TMF Governance</td>
                    <td>Retention Classification</td>
                    <td>VERIFIED</td>
                    <td>Purview Compliance Maintained</td>
                </tr>
            </table>
        </div>
        ...
        <div class=\"section\">
            ...
            <div style=\"margin-top:20px;padding:24px;border-radius:16px;background:#081521;border:1px solid #16344c;\">
                ...
                <h3 style=\"margin-top:0;color:#7fdcff;\">Why Governance Blocked?</h3>

                <ul style=\"line-height:2;\">
                    <li>SAE review evidence remains unresolved across downstream safety governance layers.</li>
                    <li>Protocol amendment reconciliation mismatch detected between Site 11 and EDC submission lineage.</li>
                    <li>Monitoring evidence dependency chain incomplete for CAPA-linked operational review.</li>
...
t = t.replace(target, inject + target)

p.write_text(t, encoding="utf-8")

print("Protocol topology v3 upgrade complete.")
