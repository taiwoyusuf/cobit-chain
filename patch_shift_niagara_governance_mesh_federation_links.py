...
MARKER = "SHIFT_NIAGARA_GOVERNANCE_MESH_FEDERATION_LINKS_ACTIVE"

if MARKER in text:
    print("Governance Mesh Federation links already exist.")
    raise SystemExit(0)

if "SHIFT_NIAGARA_GOVERNANCE_MESH_FEDERATION_ACTIVE" not in text:
    raise RuntimeError("Governance Mesh Federation marker missing.")

# ------------------------------------------------------------
# Executive Command Center nav
# ------------------------------------------------------------

target1 = '<a href="/shift-niagara-drift-federation">Niagara Drift Federation</a>'

insert1 = '''<!-- SHIFT_NIAGARA_GOVERNANCE_MESH_FEDERATION_LINKS_ACTIVE -->
...
# ------------------------------------------------------------
# Drift Federation nav
# ------------------------------------------------------------

target2 = '<a href="/shift-niagara-operational-trust-fabric">Operational Trust Fabric</a>'

insert2 = '''<a href="/shift-niagara-operational-trust-fabric">Operational Trust Fabric</a>
            <a href="/shift-niagara-governance-mesh-federation">Governance Mesh Federation</a>'''

if target2 not in text:
    raise RuntimeError("Drift Federation insertion point not found.")
...
target3 = '<tr><td>Niagara Drift Federation™</td><td>Provides governance drift federation, anomaly propagation analytics, survivability reasoning, and resilience telemetry orchestration.</td><td><a href="/shift-niagara-drift-federation">Open</a></td></tr>'
...
target4 = '<tr><td>39</td><td><a href="/shift-niagara-drift-federation">Niagara Drift Federation</a></td><td>This federates governance drift telemetry into continuously correlated enterprise resilience intelligence.</td></tr>'
...
target5 = '<a href="/shift-niagara-drift-federation">Niagara Drift Federation</a>'

insert5 = '''<a href="/shift-niagara-drift-federation">Niagara Drift Federation</a>
            <a href="/shift-niagara-governance-mesh-federation">Governance Mesh Federation</a>'''
...
print("Governance Mesh Federation links added.")
