...
MARKER = "IRLT_GOVERNANCE_STARFIELD_ENGINE_V1_ACTIVE"

if MARKER in text:
    print("Governance Starfield Engine already exists.")
    raise SystemExit()
...
print("Governance Starfield Engine appended successfully.")
