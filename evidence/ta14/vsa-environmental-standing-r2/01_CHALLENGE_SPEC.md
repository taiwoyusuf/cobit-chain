...
New evidence `E2` re-establishes critical-zone representativeness and particle-monitoring representativeness under `G2/A2`, but does not include a dynamic recovery study under the new load.
