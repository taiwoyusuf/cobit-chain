...
MARKER = "COBITCHAIN_PLATFORM_AI_AUTONOMY_ASSURANCE_MODEL_V3_ACTIVE"

all_routes = [
    "/platform/ai-autonomy-assurance-model",
    ...
    "/api/platform/ai-autonomy/assurance-model/demo",
...
Path("platform_ai_autonomy_assurance_model_v3_urls.txt").write_text(
    "\n".join([
        ...
        "http://127.0.0.1:5000/api/platform/ai-autonomy/assurance-model/demo",
...
print("COBIT-Chain AI Autonomy Assurance Model v3 installed.")
