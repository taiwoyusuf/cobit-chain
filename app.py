# CI_SUBMISSION_PACK_NAV_HEALTH_ACTIVE
...
def get_platform_health_rows():
    modules = [
        ...
        {
            "tier": "Strategic Blueprint",
            "module": "CI + MyAccess Readiness Blueprint",
            "route": "/ci-myaccess-blueprint",
            "test_route": "",
            "register": "COMPOSITE_VIEW:ci-myaccess-blueprint",
        ...
        {
            "tier": "CI Governance",
            "module": "CI Candidate Review Board",
            "route": "/ci-candidate-review",
            "test_route": "/ci-candidate-review",
            "register": "ci_candidate_review_events.csv",
            "purpose": "Owner/reviewer decision layer for approving, rejecting, requesting more data, holding duplicate checks, or marking CI candidates ServiceNow-ready with hash-backed review lineage."
        },
        {
            "tier": "CI Governance",
            "module": "CI Submission Pack",
            "route": "/ci-submission-pack",
            "test_route": "/ci-submission-pack.csv",
            "register": "COMPOSITE_VIEW:ci-submission-pack",
            "purpose": "Read-only ServiceNow-ready CI submission view and CSV export for candidates approved by the CI Review Board."
        },
        {
...
<div class="card"><span class="badge strategy">CI REVIEW</span><h3>CI Candidate Review Board</h3><p>Owner/reviewer decision layer for approving, rejecting, requesting more data, holding for duplicate check, or marking CI candidates ServiceNow-ready.</p><a href="/ci-candidate-review">Open CI Review Board</a></div>
<div class="card"><span class="badge strategy">CMDB PACK</span><h3>CI Submission Pack</h3><p>Shows only candidates marked ServiceNow-ready and prepares a controlled CSV submission pack for CMDB owner validation and future ServiceNow integration.</p><a href="/ci-submission-pack">Open CI Submission Pack</a></div>
...
<div class="warning">
<b>Suggested demo path:</b> Command Center → Operational Lineage → CI + MyAccess Blueprint → CI Candidate Factory → CI Review Board → CI Submission Pack → QC Ops Intake → Technicians → Shift Enterprise → Handoff Lineage → ServiceNow Live Tickets → ServiceNow CI Readiness → Suggested KB → KB Usage → Knowledge Governance → Knowledge Review → Knowledge Passport → Executive Overview → Architecture → Roadmap.
</div>
</main>
</body>
</html>
...
<a href="/ci-submission-pack">CI Submission Pack</a>
<a href="/qc-ops-intake">QC Ops Intake</a>
<a href="/technicians">Technicians</a>
<a href="/shift-assurance-enterprise">Shift Enterprise</a>
<a href="/shift-handoff-lineage">Handoff Lineage</a>
...
<td><a href="/ci-myaccess-blueprint">CI + MyAccess Blueprint</a></td>
<td>Future-state expansion for CI creation and access governance.</td>
<td>“We have proven live ticket-to-audit lineage. The next controlled expansion is binder/Excel-to-CI and MyAccess readiness: Blue Mountain asset, SuccessFactors training, MyAccess approval, ServiceNow CI, CI Passport, Access Passport, and audit lineage.”</td>
</tr>
...
<td><a href="/ci-candidate-review">CI Candidate Review Board</a></td>
<td>Owner/reviewer decision layer before ServiceNow CMDB submission.</td>
<td>“The factory does not blindly create CIs. The review board lets an owner approve, reject, request more data, hold for duplicate check, or mark a candidate ServiceNow-ready.”</td>
</tr>

<tr>
<td class="stepno">6</td>
<td><a href="/ci-submission-pack">CI Submission Pack</a></td>
<td>Controlled ServiceNow-ready CI submission view.</td>
<td>“Only candidates marked ServiceNow-ready appear here. This prepares a reviewed CSV submission pack for CMDB owner validation, duplicate reconciliation, and future ServiceNow integration.”</td>
</tr>
