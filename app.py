...
<div class="warning">
<b>Suggested demo path:</b> Command Center → Operational Lineage → CI + MyAccess Blueprint → CI Candidate Factory → CI Review Board → QC Ops Intake → Technicians → Shift Enterprise → Handoff Lineage → ServiceNow Live Tickets → ServiceNow CI Readiness → Suggested KB → KB Usage → Knowledge Governance → Knowledge Review → Knowledge Passport → Executive Overview → Architecture → Roadmap.
</div>
</main>
</body>
</html>
