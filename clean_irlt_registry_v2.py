...
# Ensure Flask imports are complete
...
END = "# END IRLT_DYNAMIC_MODULE_REGISTRY_V2\n# ============================================================"

# Remove previous partial/broken V2 block if present
s = text.find(START)
e = text.find(END)
if s != -1 and e != -1:
    e = e + len(END)
...
print("Clean IRLT Registry V2 installed.")
