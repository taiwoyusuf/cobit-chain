...
MARKER = "IRLT_GOVERNANCE_OMNIVERSE_ENGINE_V1_ACTIVE"

if MARKER in text:
    print("Governance Omniverse Engine already exists.")
    raise SystemExit()
...
print("Governance Omniverse Engine appended successfully.")
