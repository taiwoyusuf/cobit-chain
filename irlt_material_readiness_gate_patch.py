...
MARKER = "IRLT_MATERIAL_READINESS_GATE_VIEW_V1_ACTIVE"

if MARKER in text:
    print("IRLT Material Readiness Gate View already exists.")
    raise SystemExit()
...
print("IRLT Material Readiness Gate View appended successfully.")
